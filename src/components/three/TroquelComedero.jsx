...
export function Dav(props) {
	const { nodes, materials } = useGLTF("/gltf/TroquelComedero.gltf");
	return (
	  <group {...props} dispose={null}>
		{/* <mesh
		  ...
		  position={[0.251, 0, -0.05]}
		  scale={1.782}
		/> */}
		<mesh
		  castShadow
		  receiveShadow
		  geometry={nodes.BBB.geometry}
		  material={materials["TQ_ARD_front.001"]}
		/>
		<mesh
		  castShadow
		  receiveShadow
		  geometry={nodes.BBB_1.geometry}
		  material={materials["TQ_ARD_back.001"]}
		/>
		<mesh
		  castShadow
		  receiveShadow
		  geometry={nodes.BBB_2.geometry}
		  material={materials["TQ_ARD_edge.001"]}
		/>
		<mesh
		  castShadow
		  receiveShadow
		  geometry={nodes.BBB_3.geometry}
		  material={materials.TQ_ARD_front}
		/>
		<mesh
		  castShadow
		  receiveShadow
		  geometry={nodes.BBB_4.geometry}
		  material={materials.TQ_ARD_back}
		/>
		<mesh
		  castShadow
		  receiveShadow
		  geometry={nodes.BBB_5.geometry}
